            ...
            if True: # Always use Streaming ReAct loop for speed & reliability
                ...
                if _is_browser_use:
                    ...
                    system = (
                        ...
                        "returns nothing, the app may be hiding its UIA tree. Call `electron_check` then "
                        "`electron_unlock` — you may pass just the app NAME (e.g. \"Discord\"); it resolves "
                        "the running .exe for you. electron_unlock relaunches with accessibility enabled; then "
                        "wait a few seconds (the tree loads lazily) and retry uia_find.\n"
                        ...
                        "name, uia_wait, or electron_unlock, and if still stuck say so plainly in finish.\n"
