...
TOOL_DESCRIPTIONS = {
    ...
    ActionType.uia_type: "uia_type: {\"query\": str, \"text\": str, \"app\": str, \"clear_first\": bool} — set text into an editable control (text box, search field) found by NAME/AutomationId, using the UIA ValuePattern (instant) or focus+type fallback. No screenshot or coordinate math needed. Set clear_first=true to replace existing content.",
...
TOOL_PACKS = {
    ...
    "uia": [ActionType.uia_find, ActionType.uia_click, ActionType.uia_type, ActionType.electron_check, ActionType.electron_unlock, ActionType.focus_window, ActionType.wait_for_window],
