...
TOOL_PACKS = {
    ...
    "terminal": [ActionType.run_command, ActionType.bash, ActionType.git, ActionType.run_tests, ActionType.lint_code, ActionType.find_symbol, ActionType.list_processes, ActionType.kill_process, ActionType.run_and_watch],
