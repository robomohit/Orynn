...
AI Computer can read local context, call LLM providers, run code, browse the web,
...
accessibility trees as untrusted data. AI Computer wraps fetched web content with
